...
CREATE TABLE Accounts(
    ...
    connectStove_aws INTEGER,
    connectWashingMashine_aws INTEGER,
    connectDishWasher_aws INTEGER,
    connectSewage_aws INTEGER,
    relocationsNumber_aws INTEGER,
    internationalRelocations_aws INTEGER,
    overseaRelocations_aws INTEGER,
    supraregionalRelocations_aws INTEGER,
    storage_aws INTEGER,
    ownStorageFacility_aws INTEGER,
    foreignStorageFacility_aws INTEGER,
    additionalCargo_aws INTEGER,
    kitchenMounting_aws INTEGER,
    furnitureMounting_aws INTEGER, 
    setupHomeCinema_aws INTEGER,
    setupInternet_aws INTEGER,
    setupSatReciever_aws INTEGER,
    setupTv_aws INTEGER,
    connectElectronicDevices_aws INTEGER,
    signsStickers_aws INTEGER,
    soilProtection_aws INTEGER,
    freeInspection_aws INTEGER,
    chargeableInspection_aws INTEGER,
    artTransport_aws INTEGER,
    carpentryWork_aws INTEGER,
    electricalInstallation_aws INTEGER,
    paintingWork_aws INTEGER,
    customProcedures_aws INTEGER,
    wallProtection_aws INTEGER,
    appartementFinalCleaning_aws INTEGER,
    pianoTransport_aws INTEGER,
    premiumPartner_aws INTEGER,
    association_aws varchar(255),
    ratingAccount_aws FLOAT,
    accountFolderId varchar(255),
    biddingDisabled INTEGER,
    contactGivingDisabled INTEGER,
    ownerId varchar(40),
    volumeMin INTEGER,
    volumeMax INTEGER,
    PRIMARY KEY (id_aws)
